...
<section id="contact">
	<div class="container bg-main section-padding mt-4">
		...
		?>
		<br>
		<form action="<?php echo site_url('user/authentify') ?>" method="post">
			<div>
			...
			<div class="mt-4 text-center">
				...
				<button name="register" class="btn btn-mat btn-success"><a
						href="<?php echo site_url('user/register') ?>">Registrieren</a></button>
				<br>
			</div>
		</form>
	</div>
